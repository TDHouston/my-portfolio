...
const FirstProject = () => {
  return (
    <div className="main-container flex w-[1728px] pt-[48px] pr-[96px] pb-[48px] pl-[96px] justify-between items-center flex-nowrap bg-[#f4f4f4] relative overflow-hidden mx-auto my-0">
